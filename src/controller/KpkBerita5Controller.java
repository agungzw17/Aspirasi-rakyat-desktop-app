 ...
 * @author PIJE
 */
public class KpkBerita5Controller implements Initializable {
    ...
    public void instansiPemerintahanBeranda(ActionEvent event) throws IOException {
        Parent instansiPemerintahan = FXMLLoader.load(getClass().getResource("/beranda/beranda.fxml"));
                Scene scene = new Scene(instansiPemerintahan);
                Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
                window.setScene(scene);
                window.initModality(Modality.APPLICATION_MODAL);
    ...
    public void backLogin(ActionEvent event) throws IOException {
        Parent beranda = FXMLLoader.load(getClass().getResource("/login/login.fxml"));
                Scene scene = new Scene(beranda);
                Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
                window.setScene(scene);
                window.initModality(Modality.APPLICATION_MODAL);
